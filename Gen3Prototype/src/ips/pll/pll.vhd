...
-- Module  Version: 5.7
--E:\Programs\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n pll -lang vhdl -synth lse -arch se5c00 -type pll -fin 53.2 -mdiv 1 -ndiv 1 -trimp 0 -phasep 0 -trimp_r -adiv 4 -trims 0 -phases 0 -trims_r -bdiv 7 -phase_cntl STATIC -fb_mode 1 -lock 

-- Thu Apr 06 13:31:04 2023
...
architecture Structure of pll is
    ...
    attribute FREQUENCY_PIN_CLKOS of PLLInst_0 : label is "30.400000";
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_CPHASE=>  6, CLKOP_FPHASE=>  0, CLKOP_CPHASE=>  3, 
        ...
        CLKOS_DIV=>  7, CLKOP_DIV=>  4, CLKFB_DIV=>  1, CLKI_DIV=>  1, 
        FEEDBK_PATH=> "CLKOP")
